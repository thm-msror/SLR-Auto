...
Query Execution 
Model-based re-ranking of shots
Concept Synonyms 
Concept Models 
Lesk Similarity 
WordNet 
...
x Tokenize query text 
x Get stems 
x Resolve phrases 
Step 2: Query-Concept map 
x Synonym expansion 
x Score computation 
x Score aggregation 
Step 4: Model-based re-
ranking of shots 
x Execute text query 
x Fuse with model-based 
retrieval results
Step 3: Model-based 
retrieval of shots 
x Evaluate models
x Fuse using concept 
weights & rank shots 
Existing
text / speech 
metadata 
Model-based ranking of shots
Query-to-concept mapping weights
...
airplane 
air, aircraft, airline, carrier, helicopter, vehicle, 
warplane
natural 
disaster
disaster, 
...
sports 
sport, baseball, basketball, soccer, tennis, 
...
Let S1 = senses(term1)
Let S2 = senses(term2)
for all (s1, s2) where s1 F S1, s2 F S2
maxlesk = max(lesk(s1, s2)) }
Algorithm 1.
(maxlesk) Approach to sense disambiguation in 
...
shaking hands 
Take someone's hands and shake … 
basketball player 
...
T1: people
people-marching: 4737, crowd: 4737, … 
T2: banner
people-marching: 216, US flag: 151, … 
T3: sign
building: 5361, waterscape/front: 531, … 
...
Tešiü, T. Volkmer, “IBM Research TRECVID-2005 Video Retrieval 
System,” TRECVID Workshop, Gaithersburg, MD, Nov,  2005. 
[2] A. Natsev, M.R. Naphade, J. Tešiü, “Learning the Semantics of 
Multimedia Queries and Concepts from a Small Number of 
Examples,” ACM Multimedia, Singapore, pp. 598-607, Nov, 2005. 
[3] S. Banerjee, T. Pedersen, “Extended Gloss Overlaps as a 
Measure of Semantic Relatedness,” Joint Conference on Artificial 
Intelligence, Morgan K., Mexico, pp. 805-810, Aug. 9-15, 2003. 
...
Linguistics, Springer, Mexico, pp. 241-257, Feb. 16-22, 2003. 
[5] L.S. Kennedy, A. Natsev, S.F. Chang, “Automatic Discovery 
of Query-Class-Dependent Models for Multimodal Search,” ACM
Multimedia, ACM Press, Singapore, pp. 882-891, Nov. 6-11, 2005. 
[6] M. Naphade, J.R. Smith, F. Souvannavong, “On the Detection 
of Semantic Concepts at TRECVID,” ACM Multimedia, ACM 
...
IBM Research Tech. Report, RC23612 (W0505-104), May, 2005.
1764
